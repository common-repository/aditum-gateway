...
class WC_Aditum_Boleto_Pay_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->icon               = apply_filters( 'woocommerce_aditum_boleto_icon', plugin_dir_url(__DIR__) . 'assets/icon.png' );
		...
		$this->debug          = $this->get_option( 'aditum_boleto_debug' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			...
			array(
				...
				'aditum_boleto_debug'           => array(
					'title'   => __( 'Habilitar debug:', 'wc-aditum-boleto' ),
					'type'    => 'checkbox',
					'label'   => __( 'Habilitar ou desabilitar o debug', 'wc-aditum-boleto' ),
					'default' => 'no',
				),
				...
				'title'                         => array(
					...
					'default'     => __( 'Aditum Gateway - Boleto', 'wc-aditum-boleto' ),
					'desc_tip'    => true,
				),
				'description'                   => array(
					...
					'default'     => __( 'Pague com total segurança através do boleto bancário.', 'wc-aditum-boleto' ),
					'desc_tip'    => true,
				),
				'instructions'                  => array(
	...
	public function process_payment( $order_id ) {
		...
		$boleto->setSessionId($antifraud_token);
